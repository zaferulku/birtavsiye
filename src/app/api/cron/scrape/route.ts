...
const ROTATIONS = [
  ...
  { source: "pttavm",     query: "iphone 17e",             category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 16 pro max",      category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 16 pro",          category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 16 plus",         category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 16",              category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 16e",             category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 15 pro max",      category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 15 pro",          category_id: PHONE_CAT },
  { source: "pttavm",     query: "iphone 15 plus",         category_id: PHONE_CAT },
