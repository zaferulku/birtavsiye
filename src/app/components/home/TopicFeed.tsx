  ...
  return (
    <div className="flex flex-col h-full bg-[#FAFAF8]">
      ...
      <div className="bg-white border-b border-gray-100 px-4 pt-3 pb-0">
        ...
        {/* Cinsiyet sekmeleri — her zaman görünür */}
        <div className="flex items-center gap-1.5 px-1 py-1.5 border-t border-gray-100">
          <button
            onClick={() => { if (!user) { window.location.href = "/giris"; return; } setGenderFilter(genderFilter === "kadin" ? "hepsi" : "kadin"); }}
          ...
          <button
            onClick={() => { if (!user) { window.location.href = "/giris"; return; } setGenderFilter(genderFilter === "erkek" ? "hepsi" : "erkek"); }}
          ...
          <button
            onClick={() => { if (!user) { window.location.href = "/giris"; return; } setGenderFilter(genderFilter === "tumu" ? "hepsi" : "tumu"); }}
