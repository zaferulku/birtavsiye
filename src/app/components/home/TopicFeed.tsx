  ...
  return (
    <div className="flex flex-col h-full bg-[#FAFAF8]">
      ...
      <div className="bg-white border-b border-gray-100 px-4 pt-3 pb-0">
        ...
        {/* Kategori sekmeleri + Ara + Soru Sor */}
        <div className="flex items-center">
          <div className="flex gap-0 overflow-x-auto flex-1" style={{ scrollbarWidth: "none" }}>
            {CATS.map(c => {
          ...
          <div className="flex items-center gap-1 pl-1 flex-shrink-0 border-l border-gray-100">
            <button
              onClick={() => {
                setShowSearch(v => !v);
            ...
            <button
              ...
              className="flex items-center gap-1 text-[11px] font-bold px-2 py-1.5 rounded-lg bg-[#E8460A] text-white hover:bg-[#C93A08] transition-all">
