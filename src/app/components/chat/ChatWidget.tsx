...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed right-4 bottom-24 z-50 w-[min(340px,calc(100vw-2rem))] h-[min(48vh,480px)] bg-white border border-gray-200 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
