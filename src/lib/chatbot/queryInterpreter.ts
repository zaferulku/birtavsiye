...
const CATEGORY_ANCHORS: Record<string, string> = {
  ...
  "elektronik/telefon/sarj-kablo": "sarj aleti",
  "elektronik/telefon/aksesuar/mouse-pad": "mouse pad",
  "elektronik/telefon/aksesuar/laptop-cantasi": "laptop cantasi",
  "elektronik/bilgisayar-tablet/bilesenler/cevre-birim/mouse": "mouse",
  ...
  "supermarket/gida-icecek/kahve": "kahve",
  "supermarket/kahve": "kahve",
  "kahve-makinesi": "kahve makinesi",
  "kucuk-ev-aletleri/mutfak/kahve-makinesi": "kahve makinesi",
  "kucuk-ev-aletleri/mutfak/airfryer": "airfryer",
  "supermarket/konserve-sos/zeytinyagi": "fritoz yagi",
  "spor-outdoor/fitness/yoga-pilates": "yoga mati",
  "ev-yasam/temizlik/cop-torbasi-temizlik-araclari/paspas": "paspas",
  "elektronik/oyun/konsol/oyuncu-koltuk": "oyuncu koltugu",
...
const FALLBACK_CATEGORY_SLUG_MAP: Array<{ phrases: readonly string[]; slug: string }> = [
  { phrases: ["telefon kilifi", "telefon kılıfı", "telefon kiliflari", "telefon kılıfları", "cep telefonu kilifi", "iphone kilifi", "samsung kilifi", "kilif", "kılıf"], slug: "elektronik/telefon/kilif" },
  { phrases: ["sarj aleti", "şarj aleti", "sarj cihazi", "şarj cihazı", "telefon sarj aleti", "hizli sarj", "adaptör", "adaptor"], slug: "elektronik/telefon/sarj-kablo" },
  { phrases: ["mouse pad", "mousepad"], slug: "elektronik/telefon/aksesuar/mouse-pad" },
  { phrases: ["laptop cantasi", "laptop çantası", "notebook cantasi", "bilgisayar cantasi"], slug: "elektronik/telefon/aksesuar/laptop-cantasi" },
  { phrases: ["oyuncu mouse", "gaming mouse", "mouse", "fare"], slug: "elektronik/bilgisayar-tablet/bilesenler/cevre-birim/mouse" },
  { phrases: ["filtre kahve makinesi", "kahve makinesi", "kahve makinasi", "kahve makineleri", "kahve makinelerini", "espresso makinesi"], slug: "kucuk-ev-aletleri/mutfak/kahve-makinesi" },
  { phrases: ["filtre kahve"], slug: "supermarket/kahve/filtre-kahve" },
  { phrases: ["yoga mati", "yoga matı", "pilates mati", "pilates matı", "mat"], slug: "spor-outdoor/fitness/yoga-pilates" },
  { phrases: ["kapi mati", "kapı matı", "kapi paspasi", "kapı paspası", "paspas"], slug: "ev-yasam/temizlik/cop-torbasi-temizlik-araclari/paspas" },
  { phrases: ["airfryer", "hava fritozu", "hava fritözü", "fritoz makinesi", "fritöz makinesi"], slug: "kucuk-ev-aletleri/mutfak/airfryer" },
  { phrases: ["fritoz yagi", "fritöz yağı", "kizartma yagi", "kızartma yağı"], slug: "supermarket/konserve-sos/zeytinyagi" },
  { phrases: ["oyuncu koltugu", "oyuncu koltuğu", "gaming koltuk"], slug: "elektronik/oyun/konsol/oyuncu-koltuk" },
  ...
  { phrases: ["kahve makinesi", "kahve makineleri", "kahve makinelerini"], slug: "kahve-makinesi" },
