...
export const MEDIAMARKT_CATEGORY_MAP: MmCategoryTarget[] = [
  ...
  { dbSlug: 'ankastre-firin', mmBreadcrumbNames: ['Ankastre Fırın'], priority: 2 },
  { dbSlug: 'robot-supurge', mmBreadcrumbNames: ['Robot Süpürge'], priority: 1 },
  ...
  { dbSlug: 'blender', mmBreadcrumbNames: ['Blender'], priority: 2 },
