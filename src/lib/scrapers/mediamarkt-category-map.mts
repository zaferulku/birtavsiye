...
export const MEDIAMARKT_CATEGORY_MAP: MmCategoryTarget[] = [
  ...
  { dbSlug: 'akilli-saat', mmBreadcrumbNames: ['Akıllı Saatler', 'Amazfit Akıllı Saat', 'Bilicra Akıllı Saat', 'Huawei Akıllı Saatler', 'Samsung Akıllı Saatler', 'TCL Akıllı Saatler', 'Xiaomi Akıllı Saatler'], priority: 1 },
  ...
  { dbSlug: 'tablet', mmBreadcrumbNames: ['Tabletler', 'Android Tabletler', 'iPad', 'iPad Air', 'iPad Mini', 'iPad Pro'], priority: 1 },
  ...
  { dbSlug: 'oyun-konsol', mmBreadcrumbNames: ['Oyun Konsolları', 'PlayStation', 'Xbox', 'Nintendo', 'Nintendo Oyunları', 'Playstation Oyunları', 'Xbox Oyunları'], priority: 2 },
  { dbSlug: 'buzdolabi', mmBreadcrumbNames: ['Buzdolabı', 'Alttan Donduruculu Buzdolabı', 'Ankastre Buzdolabı', 'Altus Buzdolabı', 'Bosch Buzdolabı', 'Çift Kapılı Gardrop Tipi Buzdolabı', 'Electrolux Buzdolabı', 'Grundig Buzdolabı', 'Mini Buzdolabı', 'No Frost Buzdolabı', 'Profilo Buzdolabı', 'Samsung Buzdolabı', 'Siemens Buzdolabı', 'Üstten Donduruculu Buzdolabı'], priority: 1 },
  ...
  { dbSlug: 'fotograf-kamera', mmBreadcrumbNames: ['Fotoğraf Makineleri', 'Aynasız Fotoğraf Makineleri', 'Dijital Kompakt Fotoğraf Makinesi', 'Profesyonel DSLR Fotoğraf Makineleri', 'Şipşak Fotoğraf Makineleri'], priority: 2 },
