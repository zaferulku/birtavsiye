// Kategori kartları için manuel seçilmiş görseller.
// Bu slug'lar için ürün görseli yerine buradaki görsel gösterilir.
// Dosyalar: public/categories/<grup>/<slug>.jpg
...
export const CATEGORY_IMAGE_OVERRIDES: Record<string, string> = {
  ...
  "beyaz-esya": "/categories/ev-yasam/beyaz-esya.jpg",
};
